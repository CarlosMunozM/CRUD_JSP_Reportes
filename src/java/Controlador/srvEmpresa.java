            ...
            switch (accion) {
                ...
                case "insertarEmpresa":
                    try {
                        ...
                        empresa.setRazon_social(request.getParameter("razonSocial"));
                        ...
                        if (empresaDAO.insertarEmpresa(empresa)) {
                ...
                case "modificarEmpresa":
                    try {
                        ...
                        empresa.setId_empresa(Integer.parseInt(request.getParameter("idEmpresa")));
                        empresa.setNombre(request.getParameter("nombre"));
                        empresa.setRazon_social(request.getParameter("razonSocial"));
                        empresa.setRuc(request.getParameter("ruc"));
                        empresa.setDireccion(request.getParameter("direccion"));
                        ...
                        if (empresaDAO.modificarEmpresa(empresa)) {
                            response.getWriter().write("ok");
                        } else {
                            response.getWriter().write("Error");
                        }
                ...
                case "eliminarEmpresa":
                    try {
                        ...
                        if (empresaDAO.eliminarEmpresa(empresa)) {
                            response.getWriter().write("ok");
                        } else {
                            response.getWriter().write("Error");
                        }
