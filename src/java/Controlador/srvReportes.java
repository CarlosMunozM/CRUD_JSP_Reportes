            ...
            switch (accion) {
                ...
                case "empresas":
                    ...
                    try {
                        ...
                        //File reportFile = new File(getServletContext().getRealPath("reportes/rptEmpresas.jasper"));
                        Map<String, Object> parametros = new HashMap<String, Object>();

                        byte[] bytes = JasperRunManager.runReportToPdf(reportFile.getPath(), parametros, cnn.getConexion());
