    ...
    <body>
        <%
            ...
            try {
                ...
                File reportFile = new File(application.getRealPath("reportes/rptEmpleadosPorEmpresa.jasper"));
                Map<String, Object> parametros = new HashMap<String, Object>();
                parametros.put("id",Integer.parseInt(request.getParameter("idEmpresa")));
